...
function Projets () {
    return (
        <section className="sectionProjets" id="projets">
            ...
            <a href="https://darielpeach.github.io/openclassrooms-projet2/" target="_blank" rel="noopener noreferrer">
                <img src={Booki} alt="Booki" />
                <h4>Booki</h4>
                <p><b>Langages utilisés : </b>HTML, CSS</p>
            </a>
            <div className="repo-link">
                <a href="https://github.com/darielpeach/openclassrooms-projet2" target="_blank" rel="noopener noreferrer">
                    <button className="github-button"><b>Repo GitHub</b></button>
                </a>
            </div>
        </div>
